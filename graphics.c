...
const struct EFI_GRAPHICS_OUTPUT_BLT_PIXEL blue = {0xff, 0x00, 0x00, 0xff};
const struct EFI_GRAPHICS_OUTPUT_BLT_PIXEL red = {0x00, 0x00, 0xff, 0xff};
const struct EFI_GRAPHICS_OUTPUT_BLT_PIXEL black = {0x00, 0x00, 0x00, 0xff};
